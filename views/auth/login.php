      ...
      <div class="p-8 space-y-5">
        ...
        <div>
          ...
          <div class="relative mt-1">
            ...
            <input type="email" class="w-full pl-10 pr-3 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 outline-none" placeholder="Email">
          </div>
        </div>
        ...
        <div>
          ...
          <div class="relative mt-1">
            ...
            <input type="password" class="w-full pl-10 pr-10 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 outline-none" placeholder="Password">
        ...
        <button class="w-full py-3 rounded-xl text-white font-bold bg-gradient-to-r from-blue-600 to-emerald-500 hover:opacity-90">
          Login
        </button>
