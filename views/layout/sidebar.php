    ...
    <nav class="flex-1 p-3 flex flex-col gap-1 overflow-y-auto">
        ...
        <a href="index.php?action=dashboard"
            class="<?= $page === 'dashboard'
                ...
                : 'flex items-center gap-3 px-3.5 py-2.5 rounded-lg text-slate-400 hover:text-slate-100 hover:bg-slate-800/50 font-medium text-sm transition-all group' ?>">
            <i class="fa-solid fa-chart-pie text-base w-5 text-center"></i>
            <span>Dashboard</span>
        </a>

        <a href="index.php?action=products"
            class="<?= $page === 'products' || $page === 'products_create' || $page === 'products_edit'
                ? 'flex items-center gap-3 px-3.5 py-2.5 rounded-lg bg-blue-600 text-white font-medium text-sm'
                : 'flex items-center gap-3 px-3.5 py-2.5 rounded-lg text-slate-400 hover:text-slate-100 hover:bg-slate-800/50 font-medium text-sm transition-all group' ?>">
        ...
        <a href="index.php?action=batches"
            class="<?= $page === 'batches' || $page === 'batches_create' || $page === 'batch_edit'
                ? 'flex items-center gap-3 px-3.5 py-2.5 rounded-lg bg-blue-600 text-white font-medium text-sm'
                : 'flex items-center gap-3 px-3.5 py-2.5 rounded-lg text-slate-400 hover:text-slate-100 hover:bg-slate-800/50 font-medium text-sm transition-all group' ?>">
        ...
        <a href="index.php?action=stock_movements"
            class="<?= $page === 'stock_movements' || $page === 'stock_create' 
                ? 'flex items-center gap-3 px-3.5 py-2.5 rounded-lg bg-blue-600 text-white font-medium text-sm'
                : 'flex items-center gap-3 px-3.5 py-2.5 rounded-lg text-slate-400 hover:text-slate-100 hover:bg-slate-800/50 font-medium text-sm transition-all group' ?>">
        ...
        <a href="index.php?action=reports"
            class="<?= $page === 'reports'|| $page === 'report_expired' || $page === 'report_stock' || $page === 'report_movements' || $page === 'report_expiring'
                ? 'flex items-center gap-3 px-3.5 py-2.5 rounded-lg bg-blue-600 text-white font-medium text-sm'
                : 'flex items-center gap-3 px-3.5 py-2.5 rounded-lg text-slate-400 hover:text-slate-100 hover:bg-slate-800/50 font-medium text-sm transition-all group' ?>">
        ...
        <a href="index.php?action=user_index"
            class="<?= $page === 'user_index' || $page === 'user_create' || $page === 'user_edit'
                ? 'flex items-center gap-3 px-3.5 py-2.5 rounded-lg bg-blue-600 text-white font-medium text-sm'
                : 'flex items-center gap-3 px-3.5 py-2.5 rounded-lg text-slate-400 hover:text-slate-100 hover:bg-slate-800/50 font-medium text-sm transition-all group' ?>">
