...
<div class="flex h-screen w-screen overflow-hidden">
    ...
    <aside class="w-60 bg-slate-900 text-white flex flex-col flex-shrink-0 border-r border-slate-800 hidden md:flex">
        ...
        <!-- Dashboard Navigation Routes Matrix -->
        <nav class="flex-1 p-3 flex flex-col gap-1 overflow-y-auto">
            ...
            <!-- Batches Active Parameter Highlights -->
            <a href="index.php?action=batch_index" class="flex items-center gap-3 px-3.5 py-2.5 rounded-lg bg-blue-600 text-white font-medium text-sm transition-all shadow-sm shadow-blue-600/10">
            ...
            <a href="#" class="flex items-center gap-3 px-3.5 py-2.5 rounded-lg text-slate-400 hover:text-slate-100 hover:bg-slate-800/50 font-medium text-sm transition-all group">
                ...
                <span class="ml-auto bg-rose-500 text-white text-[10px] font-bold px-2 py-0.5 rounded-full">5</span>
            </a>
