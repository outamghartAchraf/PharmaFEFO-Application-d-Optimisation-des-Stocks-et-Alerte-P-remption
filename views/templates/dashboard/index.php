...
<div class="flex h-screen w-screen overflow-hidden">
    ...
    <aside class="w-60 bg-slate-900 text-white flex flex-col flex-shrink-0 border-r border-slate-800 hidden md:flex">
        ...
        <nav class="flex-1 p-3 flex flex-col gap-1 overflow-y-auto">
            ...
            <a href="index.php?action=dashboard" class="flex items-center gap-3 px-3.5 py-2.5 rounded-lg bg-blue-600 text-white font-medium text-sm transition-all shadow-sm shadow-blue-600/10">
                <i class="fa-solid fa-chart-pie text-base w-5 text-center"></i>
                <span>Dashboard</span>
            </a>

            <a href="index.php?action=products" class="flex items-center gap-3 px-3.5 py-2.5 rounded-lg text-slate-400 hover:text-slate-100 hover:bg-slate-800/50 font-medium text-sm transition-all group">
            ...
            <a href="index.php?action=notifications_index" class="flex items-center gap-3 px-3.5 py-2.5 rounded-lg text-slate-400 hover:text-slate-100 hover:bg-slate-800/50 font-medium text-sm transition-all group justify-between">
                ...
                <span class="bg-red-500/20 text-red-400 text-[10px] font-bold px-1.5 py-0.5 rounded-md border border-red-500/10">5</span>
            </a>
